...
public class Upload_departmentICS_news extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_department_ics_news);
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            ...
                            Toast.makeText(Upload_departmentICS_news.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
        ...
        uploadDate.setOnClickListener(v -> {
            DatePickerDialog datePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
                ...
                public void onDateSet(DatePicker view1, int year1, int month1, int dayOfMonth) {
                    ...
                    TimePickerDialog timePickerDialog = new TimePickerDialog(Upload_departmentICS_news.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (uploadTitle.getText().toString().isEmpty() ||
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Upload_departmentICS_news.this);
    ...
    public void saveData() {
        ...
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("Android Images / Department Section")
    ...
    public void uploadData() {
        ...
        FirebaseDatabase.getInstance().getReference("Department News").child(String.valueOf(currentDate))
                .setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(Upload_departmentICS_news.this, "Saved", Toast.LENGTH_SHORT).show();
                            // Notification
                            FcmNotificationsSender notificationsSender = new FcmNotificationsSender("/topics/All",NotifTitle, NotifMessage, getApplicationContext(), Upload_departmentICS_news.this);
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Upload_departmentICS_news.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                });
