...
public class upload_department_news extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_department_news);
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            ...
                            Toast.makeText(upload_department_news.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
        ...
        uploadDate.setOnClickListener(v -> {
            DatePickerDialog datePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
                ...
                public void onDateSet(DatePicker view1, int year1, int month1, int dayOfMonth) {
                    ...
                    TimePickerDialog timePickerDialog = new TimePickerDialog(upload_department_news.this, new TimePickerDialog.OnTimeSetListener() {
                        @Override
                ...
                .setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(upload_department_news.this, "Saved", Toast.LENGTH_SHORT).show();
                            // Notification
                            FcmNotificationsSender notificationsSender = new FcmNotificationsSender("/topics/All",NotifTitle, NotifMessage, getApplicationContext(), upload_department_news.this);
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(upload_department_news.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                });
